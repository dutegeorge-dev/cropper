...
Миниатюры загружаются лениво: приложение декодирует только видимую часть списка и
не пытается одновременно держать в памяти тысячу полноразмерных файлов.
